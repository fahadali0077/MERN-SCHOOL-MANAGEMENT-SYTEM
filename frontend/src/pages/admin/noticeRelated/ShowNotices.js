                ...
                <>
                    {response ?
                        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginTop: '50px', p: 4, bgcolor: '#fff', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.06)' }}>
                            <Typography variant="h5" sx={{ mb: 2, fontFamily: "'Raleway', sans-serif", color: '#333' }}>No Notices</Typography>
                            <Typography variant="body1" sx={{ mb: 3, fontFamily: "'Open Sans', sans-serif", color: '#777' }}>There are currently no notices to display. Add a notice to broadcast it.</Typography>
