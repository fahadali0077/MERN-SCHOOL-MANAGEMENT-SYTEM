...
const ShowClasses = () => {
  ...
  const sclassRows = (sclassesList && sclassesList.length > 0)
        ...
        <>
          {getresponse ?
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginTop: '50px', p: 4, bgcolor: '#fff', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.06)' }}>
              <Typography variant="h5" sx={{ mb: 2, fontFamily: "'Raleway', sans-serif", color: '#333' }}>No Classes Created</Typography>
              <Typography variant="body1" sx={{ mb: 3, fontFamily: "'Open Sans', sans-serif", color: '#777' }}>It looks like you haven't created any classes yet. Add a class to get started.</Typography>
