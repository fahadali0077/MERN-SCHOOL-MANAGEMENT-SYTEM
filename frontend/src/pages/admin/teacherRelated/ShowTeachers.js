...
const ShowTeachers = () => {
    ...
    if (loading) {
        ...
        return (
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginTop: '50px', p: 4, bgcolor: '#fff', borderRadius: '12px', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.06)' }}>
                <Typography variant="h5" sx={{ mb: 2, fontFamily: "'Raleway', sans-serif", color: '#333' }}>No Teachers Added</Typography>
                <Typography variant="body1" sx={{ mb: 3, fontFamily: "'Open Sans', sans-serif", color: '#777' }}>You have not added any teachers. Add a new teacher to assign classes and subjects.</Typography>
    ...
    const deleteHandler = (deleteID, address) => {
        ...
        console.log(address);
        setMessage("Deletion Succsessful.")
        setShowPopup(true)
